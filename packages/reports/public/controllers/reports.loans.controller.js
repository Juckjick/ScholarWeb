(function() {
    ...
    angular
        .module('sms.reports')
        .controller('ReportsLoanController', ReportsLoan);

    ReportsLoan.$inject = ['$window', 'Global', 'Reports', 'AcademicYear'];

    function ReportsLoan($window, Global, Reports, AcademicYear) {
        var vm = this;
        ...
        function find() {
            ...
            Reports.loadLoan(data).success(function(results) {
                vm.results = results;
            });
        }

        function exportToExcel() {
            $window.open('/reports/loan');
        }
